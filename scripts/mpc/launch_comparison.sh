...
tmux new-session     "${CMD} 0 ${CONFIG_PATH} equals 3 3; sh" \; \
     splitw -h -p 50 "${CMD} 1 ${CONFIG_PATH} equals 4 4; sh" \; \
     splitw -v -p 50 "${CMD} 2 ${CONFIG_PATH} equals 5 5; sh" \; \
     selectp -t 0 \; \
     splitw -v -p 50 "${CMD} 3 ${CONFIG_PATH} equals 6 6; sh"
